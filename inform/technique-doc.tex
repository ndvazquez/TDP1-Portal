...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{umlGame.png}}
	\caption{Diagrama de clases del soporte para vistas y sonidos}
	\label{fig:diagram7}
\end{figure}
...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{umlViewManager.png}}
	\caption{Diagrama de clases del soporte para vistas y sonidos}
	\label{fig:diagram8}
\end{figure}
...
\begin{figure}[!h]
	\makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{umlViews.png}}
	\caption{Diagrama de clases del soporte para vistas y sonidos}
	\label{fig:diagram9}
\end{figure}
\newpage
