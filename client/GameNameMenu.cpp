...
#define INVALID_GAME_REQUEST "THE GAME YOU ARE LOOKING FOR DOES NOT EXIST. ENTER ONE OF THE GAMES AVAILABLE"
...
std::string GameNameMenu::start(int rst) {
    ...
    while ((rst == JOIN_ACTION && gaString.find(gameName) == std::string::npos) || gameName.empty()) {
        InputText otherInput(window, INVALID_GAME_REQUEST, GREEN_MOLD);
